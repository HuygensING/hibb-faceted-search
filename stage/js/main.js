...
(function() {
  ...
  define('models/options',['require','backbone'],function(require) {
...
(function() {
  ...
  define('models/query',['require','managers/ajax','helpers/fns','models/base','models/options'],function(require) {
...
define('text!html/facet/list.html',[],function () { return '<header><h3><%= title %></h3><small></small></header><div class="body"><div class="row span2 align middle"><div class="cell span1 center"><input type="text" name="listsearch" class="listsearch"/></div><div class="cell span1 right"><nav><ul><li class="all">All </li><li class="none">None</li></ul></nav></div></div><div class="items"><ul></ul></div></div>';});

define('text!html/facet/list.options.html',[],function () { return '<ul><% _.each(options, function(option) { %>\n<% var someId = generateID(); %>\n<% var checked = (option.get(\'checked\')) ? \'checked\' : \'\'; %><li class="item"><div class="row span6"><div class="cell span5"><input id="<%= someId %>" name="<%= someId %>" type="checkbox" data-value="<%= option.id %>" <%= checked %>><label for="<%= someId %>"><%= option.id %></label></div><div class="cell span1 right"><div class="count"><%= option.get(\'count\') %></div></div></div></li><% }); %></ul>';});
...
(function() {
  ...
  define('views/facets/list',['require','helpers/fns','models/query','models/list','collections/list.options','views/facet','views/facets/list.options','text!html/facet/list.html'],function(require) {
...
(function() {
  ...
  define('views/search',['require','models/query','views/facet','text!html/search.html'],function(require) {
...
(function() {
  ...
  define('main',['require','models/query','models/options','views/base','views/facets/list','views/search','text!html/faceted-search.html'],function(require) {
