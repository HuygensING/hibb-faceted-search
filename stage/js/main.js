...
define('text!html/search.html',[],function () { return '\n<header>\n  <h3>Text search</h3><small>more</small>\n  <div class="options">\n    <div class="row span1 align middle">\n      <div class="cell span1">\n        <input id="matchcase" type="checkbox" name="matchcase"/>\n        <label for="matchcase">Match case</label>\n      </div>\n    </div>\n    <div class="row span1">\n      <div class="cell span1">\n        <h4>Text layers</h4>\n      </div>\n    </div>\n    <div class="row span3 align middle">\n      <div class="cell span1">\n        <input id="textlayer_diplomatic" type="checkbox" name="textlayer_diplomatic"/>\n        <label for="textlayer_diplomatic">Diplomatic</label>\n      </div>\n      <div class="cell span1">\n        <input id="textlayer_critical" type="checkbox" name="textlayer_critical"/>\n        <label for="textlayer_critical">Critical</label>\n      </div>\n      <div class="cell span1">\n        <input id="textlayer_comments" type="checkbox" name="textlayer_comments"/>\n        <label for="textlayer_comments">Comments</label>\n      </div>\n    </div>\n  </div>\n</header>\n<div class="body">\n  <div class="row span4 align middle">\n    <div class="cell span3">\n      <div class="padr4">\n        <input id="search" type="text" name="search"/>\n      </div>\n    </div>\n    <div class="cell span1">\n      <button class="search">Search</button>\n    </div>\n  </div>\n</div>';});
...
(function() {
  ...
  define('views/facets/list',['require','models/list','collections/list.options','views/facet','views/facets/list.options','text!html/facet/list.html'],function(require) {
