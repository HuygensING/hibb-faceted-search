...
(function() {
  ...
  define('models/query',['require','managers/ajax','helpers/fns','models/base'],function(require) {
...
(function() {
  ...
  define('main',['require','models/query','views/base','views/facets/list','views/search','text!html/faceted-search.html'],function(require) {
